...
`,
  ...
  w = new (class {
    constructor() {
      ((this.ctx = null), (this.isMuted = !1), (this.volume = 0.8));
    }
    init() {
      if (!this.ctx) {
    ...
    playRumble(e = 2) {
      if (!this.isMuted && (this.init(), this.ctx))
        try {
          let t = this.ctx.currentTime,
            n = this.ctx.createOscillator(),
            r = this.ctx.createOscillator(),
            i = this.ctx.createGain(),
            a = this.ctx.createBiquadFilter(),
            o = this.ctx.sampleRate * e,
            s = this.ctx.createBuffer(1, o, this.ctx.sampleRate),
            c = s.getChannelData(0),
            l = 0;
          for (let e = 0; e < o; e++) {
            let t = Math.random() * 2 - 1;
            ((c[e] = (l + 0.02 * t) / 1.02), (l = c[e]), (c[e] *= 3.5));
          }
          let u = this.ctx.createBufferSource();
          ((u.buffer = s),
            (a.type = `lowpass`),
            a.frequency.setValueAtTime(140, t),
            a.frequency.exponentialRampToValueAtTime(80, t + e),
            (n.type = `sawtooth`),
            n.frequency.setValueAtTime(45, t),
            n.frequency.linearRampToValueAtTime(32, t + e),
            (r.type = `triangle`),
            r.frequency.setValueAtTime(38, t),
            r.frequency.linearRampToValueAtTime(28, t + e),
            i.gain.setValueAtTime(0.01, t),
            i.gain.linearRampToValueAtTime(0.45 * this.volume, t + 0.2),
            i.gain.setValueAtTime(0.4 * this.volume, t + e * 0.7),
            i.gain.exponentialRampToValueAtTime(0.001, t + e),
            u.connect(a),
            n.connect(a),
            r.connect(a),
            a.connect(i),
    ...
    playSiren(e = 2.2) {
      if (!this.isMuted && (this.init(), this.ctx))
        try {
          ...
          ((n.type = `sawtooth`), n.frequency.setValueAtTime(600, t));
          for (let r = 0; r < e; r += 0.8)
            (n.frequency.linearRampToValueAtTime(950, t + r + 0.4),
              n.frequency.linearRampToValueAtTime(600, t + r + 0.8));
          (r.gain.setValueAtTime(0.01, t),
            r.gain.linearRampToValueAtTime(0.2 * this.volume, t + 0.1),
            r.gain.setValueAtTime(0.2 * this.volume, t + e - 0.2),
            r.gain.exponentialRampToValueAtTime(0.001, t + e),
            n.connect(r),
      ...
      if (!this.isMuted && (this.init(), this.ctx))
        try {
          let t = this.ctx.currentTime,
            ...
            r = this.ctx.createGain();
          ((n.type = `square`),
            n.frequency.setValueAtTime(3200, t),
            r.gain.setValueAtTime(0, t),
            r.gain.setValueAtTime(0.15 * this.volume, t + 0.05),
            r.gain.setValueAtTime(0, t + 0.25),
            r.gain.setValueAtTime(0.15 * this.volume, t + 0.35),
            r.gain.setValueAtTime(0, t + 0.55),
            r.gain.setValueAtTime(0.15 * this.volume, t + 0.65),
            r.gain.setValueAtTime(0, t + 0.85),
            n.connect(r),
            r.connect(this.ctx.destination),
            n.start(t),
            n.stop(t + e));
      ...
      if (!this.isMuted && (this.init(), this.ctx))
        try {
          ...
          ((t.type = `sine`),
            ...
            t.frequency.exponentialRampToValueAtTime(400, e + 0.06),
            n.gain.setValueAtTime(0.2 * this.volume, e),
            n.gain.exponentialRampToValueAtTime(0.001, e + 0.06),
            t.connect(n),
      ...
      if (!this.isMuted && (this.init(), this.ctx))
        try {
          ...
          (this.ctx.createBiquadFilter(),
            (t.type = `triangle`),
            t.frequency.setValueAtTime(300, e),
            t.frequency.exponentialRampToValueAtTime(700, e + 0.08),
            t.frequency.exponentialRampToValueAtTime(200, e + 0.18),
            n.gain.setValueAtTime(0.01, e),
            n.gain.linearRampToValueAtTime(0.25 * this.volume, e + 0.08),
      ...
      if (!this.isMuted && (this.init(), this.ctx))
        try {
          [523.25, 659.25, 783.99, 1046.5].forEach((e, t) => {
            let n = this.ctx.currentTime + t * 0.08,
              r = this.ctx.createOscillator(),
              i = this.ctx.createGain();
            ((r.type = `sine`),
              r.frequency.setValueAtTime(e, n),
              i.gain.setValueAtTime(0.01, n),
              i.gain.linearRampToValueAtTime(0.22 * this.volume, n + 0.02),
              i.gain.exponentialRampToValueAtTime(0.001, n + 0.35),
              r.connect(i),
              i.connect(this.ctx.destination),
              r.start(n),
              r.stop(n + 0.35));
      ...
      if (!this.isMuted && (this.init(), this.ctx))
        try {
          let e = this.ctx.currentTime,
            ...
            n = this.ctx.createGain();
          ((t.type = `sawtooth`),
            t.frequency.setValueAtTime(180, e),
            t.frequency.setValueAtTime(140, e + 0.15),
            n.gain.setValueAtTime(0.2 * this.volume, e),
            n.gain.exponentialRampToValueAtTime(0.001, e + 0.35),
            t.connect(n),
            n.connect(this.ctx.destination),
            t.start(e),
            t.stop(e + 0.35));
    ...
    playThunder() {
      if (!this.isMuted && (this.init(), this.ctx))
        try {
          ...
          ((r.type = `lowpass`),
            r.frequency.setValueAtTime(400, e),
            r.frequency.exponentialRampToValueAtTime(60, e + 1.8),
            (t.type = `sawtooth`),
            t.frequency.setValueAtTime(90, e),
            t.frequency.exponentialRampToValueAtTime(30, e + 1.8),
            n.gain.setValueAtTime(0.4 * this.volume, e),
            n.gain.exponentialRampToValueAtTime(0.001, e + 1.8),
            t.connect(r),
            r.connect(n),
            n.connect(this.ctx.destination),
            t.start(e),
...
function oe({
  adventures: e,
  onSelectAdventure: t,
  completedAdventures: n = [],
}) {
  let [r, i] = (0, _.useState)(`fire`),
    a = (e) => {
      (w.playClick(), i(e));
    },
    o = (e, n) => {
      (n.stopPropagation(), w.playWhoosh(), t(e));
    };
  return (0, T.jsxs)(`div`, {
    className: `min-h-screen bg-[#181c2e] text-slate-100 flex flex-col justify-between select-none`,
    children: [
      (0, T.jsxs)(`div`, {
        className: `max-w-6xl mx-auto w-full px-4 sm:px-6 pt-10 pb-6 flex-1 flex flex-col`,
        children: [
          (0, T.jsx)(`div`, {
            className: `text-center mb-10`,
            children: (0, T.jsx)(`h1`, {
              className: `text-4xl sm:text-5xl md:text-6xl font-bold tracking-normal text-white font-comic drop-shadow-sm`,
              children: `Select Your Adventure`,
            }),
          }),
          (0, T.jsx)(`div`, {
            ...
            children: e.map((e) => {
              ...
              return (0, T.jsxs)(
                ...
                {
                  onClick: () => a(e.id),
                  className: `bg-[#212548] rounded-2xl p-6 transition-all duration-200 cursor-pointer flex flex-col items-center text-center ${t ? `ring-4 ring-amber-400 shadow-2xl shadow-amber-400/20 scale-[1.02]` : `border border-transparent hover:border-slate-600 hover:scale-[1.01]`}`,
                  children: [
                    (0, T.jsx)(`div`, {
                      className: `w-52 h-52 sm:w-56 sm:h-56 bg-slate-900 rounded-xl overflow-hidden mb-5 border border-slate-800 shadow-md flex items-center justify-center relative`,
                      children: (0, T.jsx)(`img`, {
                        src: e.thumbnail,
                        alt: e.title,
                        className: `w-full h-full object-cover transition-transform duration-300 hover:scale-105`,
                        onError: (t) => {
                          t.target.src = e.background;
                        },
                      }),
                    }),
                    (0, T.jsx)(`button`, {
                      onClick: (t) => o(e, t),
                      className: `w-full max-w-[200px] bg-[#f97316] hover:bg-[#ea580c] text-white font-bold font-comic py-2.5 px-8 rounded-xl text-xl sm:text-2xl transition-all shadow-[0_4px_0_#9a3412] hover:shadow-[0_2px_0_#9a3412] hover:translate-y-0.5 active:translate-y-1 active:shadow-none mb-4 flex items-center justify-center gap-2`,
                      children: `Play`,
                    }),
                    (0, T.jsx)(`h2`, {
                      className: `text-lg sm:text-xl font-bold font-comic text-white leading-snug`,
                      children: e.title,
                    }),
                  ],
                },
      ...
      (0, T.jsx)(`footer`, {
        className: `w-full bg-[#181c2e] border-t border-slate-800/80 px-6 py-4`,
        children: (0, T.jsxs)(`div`, {
          className: `max-w-6xl mx-auto flex items-center justify-between`,
          children: [
            (0, T.jsx)(`div`, {
              className: `text-slate-400 text-sm font-comic`,
              children: `Scroll with mouse wheel or drag to view more games`,
            }),
            (0, T.jsx)(`button`, {
              onClick: () => {
                (w.playClick(),
              ...
              className: `bg-[#1d4ed8] hover:bg-[#2563eb] text-white font-bold font-comic px-7 py-2.5 rounded-xl transition-all shadow-md active:translate-y-0.5`,
              children: `Go Back`,
            }),
          ],
        }),
...
function se({ adventure: e, onClose: t, onComplete: n }) {
  let [r, i] = (0, _.useState)(`intro`),
    [a, o] = (0, _.useState)(0),
        ...
        (p.soundCue === `rumble`
          ...
          : p.soundCue === `siren`
            ...
            : p.soundCue === `alarm`
              ...
              : p.soundCue === `thunder`
                ? w.playThunder()
                : p.soundCue === `success` && w.playSuccess(),
        p.shake)
      ) {
        c(p.shake);
        let e = setTimeout(() => c(null), 2500);
  ...
  let m = () => {
      (w.playClick(), w.playWhoosh(), i(`playing`), o(0));
    },
    h = () => {
      (w.playClick(), a < e.scenes.length - 1 ? o((e) => e + 1) : b());
    },
    g = (t) => {
      (w.playClick(),
        t.isCorrect
          ? (w.playSuccess(), a < e.scenes.length - 1 ? o((e) => e + 1) : b())
          : (w.playWrong(), f(t), u(0), i(`wrong_feedback`)));
    },
    v = () => {
      w.playClick();
      let e = d?.feedbackNarrative || [];
      l < e.length - 1 ? u((e) => e + 1) : i(`safety_tip`);
    },
    y = () => {
      (w.playClick(), w.playWhoosh(), i(`playing`), f(null), u(0));
    },
    b = () => {
      (w.playSuccess(), i(`completed`), n && n(e.id));
    };
  return (0, T.jsxs)(`div`, {
    className: `fixed inset-0 z-50 bg-[#32363f] flex flex-col items-center justify-center p-3 sm:p-6 select-none overflow-y-auto`,
    children: [
      (0, T.jsx)(`button`, {
        onClick: () => {
          (w.playClick(), t());
        ...
        title: `Close Game`,
        className: `fixed top-4 left-4 sm:top-6 sm:left-6 w-11 h-11 rounded-full bg-[#df382b] hover:bg-[#c83226] text-white border-3 border-black shadow-lg flex items-center justify-center transition-transform hover:scale-110 active:scale-95 z-50 cursor-pointer`,
        children: (0, T.jsx)(ie, { className: `w-6 h-6 stroke-[3.5]` }),
      }),
      r === `intro` &&
        (0, T.jsxs)(`div`, {
          className: `w-full max-w-[820px] bg-[#fcefe9] rounded-2xl border-4 border-black p-8 sm:p-14 text-center shadow-[6px_6px_0px_#000000] relative my-auto animate-pop`,
          children: [
            (0, T.jsx)(`h1`, {
              className: `text-3xl sm:text-5xl font-comic font-bold text-[#b93815] tracking-normal mb-4`,
              children: e.title,
            }),
            (0, T.jsx)(`p`, {
              className: `text-lg sm:text-2xl font-comic text-slate-800 mb-10 max-w-xl mx-auto`,
              children: e.subtitle,
            }),
            (0, T.jsx)(`button`, {
              onClick: m,
              className: `bg-[#f97316] hover:bg-[#ea580c] text-white font-comic font-bold text-xl sm:text-2xl px-10 py-4 rounded-2xl border-3 border-black shadow-[0_5px_0_#9a3412] hover:shadow-[0_2px_0_#9a3412] hover:translate-y-0.5 active:translate-y-1.5 active:shadow-none transition-all cursor-pointer`,
              children: `Start Adventure`,
            }),
          ],
        }),
      (r === `playing` || r === `wrong_feedback` || r === `safety_tip`) &&
        (0, T.jsxs)(`div`, {
          className: `w-full max-w-4xl bg-black rounded-lg border-4 border-black shadow-2xl relative flex flex-col justify-between overflow-hidden my-auto ${s === `heavy` ? `animate-shake-heavy` : s === `mild` ? `animate-shake-mild` : ``}`,
          style: {
            minHeight: `440px`,
            maxHeight: `85vh`,
            aspectRatio: `16/10`,
          ...
          children: [
            ...
            r === `playing` &&
              p?.type === `choice` &&
              (0, T.jsx)(`div`, {
                className: `absolute inset-x-0 top-16 sm:top-24 z-20 flex flex-col items-center justify-center gap-3 px-4 sm:px-12 animate-pop`,
                children: p.options.map((e) =>
                  (0, T.jsx)(
                    `button`,
                    {
                      onClick: () => g(e),
                      className: `w-full max-w-xl bg-[#e5532a] hover:bg-[#f97316] text-white font-comic font-bold text-base sm:text-lg px-6 py-3.5 rounded-xl border-3 border-black shadow-[0_4px_0_#991b1b] hover:shadow-[0_2px_0_#991b1b] hover:translate-y-0.5 active:translate-y-1 transition-all text-center cursor-pointer`,
                      children: e.text,
                    },
                    e.id,
                  ),
            ...
            r === `safety_tip` &&
              (0, T.jsx)(`div`, {
                className: `absolute inset-x-0 top-1/2 -translate-y-1/2 z-20 flex flex-col items-center justify-center px-4 animate-pop`,
                children: (0, T.jsx)(`button`, {
                  onClick: y,
                  className: `w-full max-w-md bg-[#b93815] hover:bg-[#d9481f] text-white font-comic font-bold text-lg sm:text-xl py-3.5 px-8 rounded-xl border-3 border-black shadow-[0_4px_0_#7c2d12] hover:shadow-[0_2px_0_#7c2d12] hover:translate-y-0.5 active:translate-y-1 transition-all cursor-pointer`,
                  children: `Try again`,
                }),
              }),
            (0, T.jsx)(`div`, {
              className: `z-20 p-3 sm:p-5`,
              children: (0, T.jsxs)(`div`, {
                className: `w-full bg-[#ffffff] rounded-2xl border-3 sm:border-4 border-black p-4 sm:p-5 shadow-[4px_4px_0px_rgba(0,0,0,0.6)] relative`,
                children: [
                  (0, T.jsx)(`div`, {
                    className: `mb-1`,
                    children: (0, T.jsx)(`span`, {
                      className: `text-xl sm:text-2xl font-comic font-bold text-[#c83e16]`,
                      children:
                        r === `wrong_feedback`
                          ? `Narrator`
                          : r === `safety_tip`
                            ? d?.safetyTip?.title || `Safety Tip`
                            : p?.speaker,
                    }),
                  }),
                  (0, T.jsx)(`p`, {
                    className: `text-base sm:text-lg font-comic text-slate-900 leading-relaxed min-h-[46px] pr-24`,
                    children:
                      r === `wrong_feedback`
                        ? d?.feedbackNarrative?.[l]?.text
                        : r === `safety_tip`
                          ? d?.safetyTip?.text
                          : p?.type === `choice`
                            ? p.question
                  ...
                  ((r === `playing` && p?.type !== `choice`) ||
                    r === `wrong_feedback`) &&
                    (0, T.jsxs)(`button`, {
                      onClick: r === `wrong_feedback` ? v : h,
                      className: `absolute bottom-3 right-3 sm:bottom-4 sm:right-4 bg-[#f97316] hover:bg-[#ea580c] text-white font-comic font-bold text-base sm:text-lg px-4 sm:px-6 py-1.5 sm:py-2 rounded-xl border-2 sm:border-3 border-black shadow-[0_3px_0_#9a3412] hover:shadow-[0_1px_0_#9a3412] hover:translate-y-0.5 active:translate-y-1 transition-all flex items-center gap-1.5 cursor-pointer`,
                      children: [
                        (0, T.jsx)(`span`, { children: `Next` }),
                        (0, T.jsx)(`span`, {
                          className: `text-xs`,
                          children: `▶`,
                        }),
      ...
      r === `completed` &&
        (0, T.jsxs)(`div`, {
          className: `w-full max-w-2xl bg-[#fcefe9] rounded-2xl border-4 border-black p-8 sm:p-12 text-center shadow-[6px_6px_0px_#000000] relative my-auto animate-pop`,
          children: [
            (0, T.jsx)(`div`, {
              className: `w-20 h-20 rounded-full bg-[#f97316] border-4 border-black mx-auto flex items-center justify-center text-4xl shadow-xl mb-4`,
              children: e.badgeIcon,
            }),
            (0, T.jsx)(`h2`, {
              className: `text-3xl sm:text-4xl font-comic font-bold text-[#b93815] mb-2`,
              children: `Adventure Completed!`,
            }),
            (0, T.jsxs)(`p`, {
              className: `text-slate-800 font-comic text-base sm:text-lg max-w-md mx-auto mb-8`,
              children: [
                `You successfully navigated the `,
                e.title,
                ` and mastered critical disaster safety actions!`,
              ],
            }),
            (0, T.jsxs)(`div`, {
              ...
              children: [
                (0, T.jsx)(`button`, {
                  onClick: () => {
                    (w.playClick(), i(`playing`), o(0), f(null), u(0));
                  },
                  className: `w-full sm:w-auto bg-[#334155] hover:bg-[#1e293b] text-white font-comic font-bold text-lg px-6 py-3 rounded-xl border-3 border-black shadow-[0_4px_0_#0f172a] hover:translate-y-0.5 active:translate-y-1 transition-all cursor-pointer`,
                  children: `Play Again`,
                }),
                (0, T.jsx)(`button`, {
                  onClick: t,
                  className: `w-full sm:w-auto bg-[#f97316] hover:bg-[#ea580c] text-white font-comic font-bold text-lg px-8 py-3 rounded-xl border-3 border-black shadow-[0_4px_0_#9a3412] hover:translate-y-0.5 active:translate-y-1 transition-all cursor-pointer`,
...
var ce = [
  {
    id: `aftershock`,
    title: `Aftershock Safety Adventure`,
    subtitle: `A story about staying safe after an earthquake.`,
    thumbnail: `/games/disaster-adventure/assets/thumb_aftershock-RaHChW5t.png`,
    background: `/games/disaster-adventure/assets/bg_aftershock_city-C0PMHwba.png`,
    category: `Earthquakes & Tremors`,
    badge: `Aftershock Safety Hero`,
    badgeIcon: `⚡`,
    difficulty: `Beginner`,
    duration: `5 mins`,
    description: `Learn how to react when severe aftershocks hit right after a major earthquake and avoid dangerous secondary hazards.`,
    scenes: [
      {
        id: `scene_1`,
        speaker: `Ishaan`,
        text: `Phew, that was the biggest earthquake I've ever felt. I'm glad we're all okay.`,
        actionSfx: null,
        soundCue: null,
        shake: !1,
      },
      {
        id: `scene_2`,
        speaker: `Meera`,
        text: `Me too. Look at the crack in the wall. The radio said to expect aftershocks.`,
        actionSfx: null,
        soundCue: null,
        shake: !1,
      },
      {
        id: `scene_3`,
        speaker: `Sound`,
        text: `*RUMBLE...* Oh no! Here comes another one! It's starting again!`,
        actionSfx: `RUMBLE...`,
        soundCue: `rumble`,
        shake: `heavy`,
      },
      {
        ...
        type: `choice`,
        speaker: `Ishaan`,
        question: `It's an aftershock! What do we do?`,
        shake: `mild`,
        options: [
          {
            id: `opt_1`,
            text: `Drop, Cover, and Hold On, just like before.`,
            isCorrect: !0,
          },
          {
            id: `opt_2`,
            ...
            feedbackNarrative: [
              {
                speaker: `Narrator`,
                text: `Running during any shaking is dangerous. The first earthquake could have weakened the building, making it even more unstable.`,
                soundCue: `wrong`,
              },
              {
                speaker: `Narrator`,
                text: `You must always take cover first until the shaking stops.`,
              },
            ],
            safetyTip: {
              title: `Safety Tip`,
              text: `Treat every aftershock like it's a major earthquake. What's the golden rule?`,
            },
          },
          {
            id: `opt_3`,
            text: `Freeze and wait for it to stop.`,
            isCorrect: !1,
            feedbackNarrative: [
              {
                speaker: `Narrator`,
                text: `Freezing leaves you exposed in the open. Light fixtures, glass, and wall plaster could fall directly onto you.`,
                soundCue: `wrong`,
              },
              {
                speaker: `Narrator`,
                text: `Never stay frozen in place! Immediately drop to your hands and knees and get under cover.`,
              },
            ],
            safetyTip: {
              title: `Safety Tip`,
              text: `Drop to the floor before the quake knocks you down. Cover your head and neck under sturdy furniture!`,
            },
          },
        ],
      },
        ...
        options: [
          ...
          },
          {
            ...
            feedbackNarrative: [
              {
                speaker: `Narrator`,
                text: `Elevators can get stuck or plummet if cables were damaged or power fails.`,
                soundCue: `wrong`,
              },
            ],
            safetyTip: {
  ...
  {
    id: `chemical`,
    title: `Chemical Spill Safety Adventure`,
    subtitle: `A story about reacting safely to hazardous chemical vapors.`,
    thumbnail: `/games/disaster-adventure/assets/thumb_chemical-BTFOehdw.png`,
    background: `/games/disaster-adventure/assets/bg_chemical_lab-CBXOImXm.png`,
    category: `Hazardous Materials`,
    badge: `Chemical Hazmat Guardian`,
    badgeIcon: `🧪`,
    difficulty: `Intermediate`,
    duration: `6 mins`,
    description: `Navigate an industrial chemical spill warning, recognize hazmat markers, shelter in place, and practice safe decontamination.`,
    scenes: [
      {
        id: `chem_1`,
        speaker: `Ishaan`,
        text: `Meera, look over at the street crossing! There's a strange yellowish vapor leaking from that overturned transport container!`,
        soundCue: `alarm`,
        shake: `mild`,
      },
      {
        id: `chem_2`,
        speaker: `Meera`,
        text: `I see a diamond warning sign! The wind is blowing the gas right towards this side of the street.`,
        actionSfx: `WARNING!`,
        shake: !1,
      },
      {
        ...
        type: `choice`,
        speaker: `Ishaan`,
        question: `Toxic fumes are spreading with the wind. In which direction must we immediately evacuate?`,
        options: [
          {
            id: `chem_opt_1`,
            text: `Move UPWIND and UPHILL, crosswise away from the vapor plume.`,
            isCorrect: !0,
          },
          {
            id: `chem_opt_2`,
            text: `Run in the same direction the wind is blowing (downwind) to outrun it.`,
            isCorrect: !1,
            feedbackNarrative: [
              {
                speaker: `Narrator`,
                text: `Running downwind keeps you directly inside the path of the toxic gas plume. The wind travels faster than you can sprint.`,
                soundCue: `wrong`,
              },
            ],
            safetyTip: {
              title: `Wind Direction Rule`,
              text: `Always move UPWIND (into the wind) and UPHILL, crosswise to the plume direction!`,
            },
          },
          {
            id: `chem_opt_3`,
            text: `Crouch down into the nearest basement or storm drain.`,
            isCorrect: !1,
            feedbackNarrative: [
              {
                speaker: `Narrator`,
                text: `Most hazardous chemical vapors are heavier than air. They sink and concentrate in basements, ditches, and storm drains.`,
                soundCue: `wrong`,
              },
            ],
            safetyTip: {
              title: `Vapor Density Hazard`,
              text: `Heavy chemical vapors pool in low areas. Seek higher ground when hazardous gas is released.`,
            },
          },
        ],
      },
        ...
        options: [
          ...
          },
          {
            ...
            feedbackNarrative: [
              {
                speaker: `Narrator`,
                text: `Chemical spills require special neutralizers and protective gear. Standard mops can cause dangerous reactions.`,
                soundCue: `wrong`,
              },
            ],
            safetyTip: {
  ...
  {
    id: `cyclone`,
    title: `Cyclone Safety Adventure`,
    subtitle: `A story about surviving powerful cyclone winds and storm surges.`,
    thumbnail: `/games/disaster-adventure/assets/thumb_cyclone-DicZ1St1.png`,
    background: `/games/disaster-adventure/assets/bg_cyclone_shelter-CDx8m6mE.png`,
    category: `Severe Storms`,
    badge: `Cyclone Survivor Champion`,
    badgeIcon: `🌀`,
    difficulty: `Intermediate`,
    duration: `6 mins`,
    description: `Prepare your home against category gale winds, recognize the deceptive calm of the storm eye, and shelter safely.`,
    scenes: [
      {
        id: `cyc_1`,
        speaker: `Ishaan`,
        text: `The meteorological alert is active! Category 4 Cyclone is making landfall with 150 km/h winds and torrential rain.`,
        soundCue: `thunder`,
        shake: `mild`,
      },
      {
        id: `cyc_2`,
        speaker: `Meera`,
        text: `The sky is pitch dark and tree branches are whipping outside. We need to secure our shelter right now.`,
        soundCue: `thunder`,
        shake: `mild`,
      },
      {
        ...
        type: `choice`,
        speaker: `Ishaan`,
        question: `Where should we stay inside during maximum gale-force cyclone winds?`,
        options: [
          {
            id: `cyc_opt_1`,
            text: `In an interior windowless room, reinforced hallway, or storm shelter.`,
            isCorrect: !0,
          },
          {
            id: `cyc_opt_2`,
            text: `Stand near the large glass living room window to watch the storm.`,
            isCorrect: !1,
            feedbackNarrative: [
              {
                speaker: `Narrator`,
                text: `Violent winds easily shatter large glass windows, sending deadly high-velocity glass shards flying across the room.`,
                soundCue: `wrong`,
              },
            ],
            safetyTip: {
              title: `Window Hazard`,
              text: `Stay completely away from all glass windows and skylights during a severe cyclone.`,
            },
          },
        ],
      },
        ...
        options: [
          ...
          },
          {
            ...
            feedbackNarrative: [
              {
                speaker: `Narrator`,
                text: `The \'eye\' of a cyclone brings a temporary calm, but destructive winds will return from the opposite direction soon.`,
                soundCue: `wrong`,
              },
            ],
            safetyTip: {
  ...
  {
    id: `earthquake`,
    title: `Earthquake Safety Adventure`,
    subtitle: `A story about rapid reflexes during high-magnitude tremors.`,
    thumbnail: `/games/disaster-adventure/assets/thumb_earthquake-XKO-_YcO.png`,
    background: `/games/disaster-adventure/assets/bg_earthquake_room-BAf36KKJ.png`,
    category: `Earthquakes & Tremors`,
    badge: `Earthquake Action Master`,
    badgeIcon: `🏛️`,
    difficulty: `Beginner`,
    duration: `5 mins`,
    description: `Master the Drop, Cover, and Hold On protocol, debunk common myths (like standing in doorways), and learn safe evacuation.`,
    scenes: [
      {
        id: `eq_1`,
        speaker: `Ishaan`,
        text: `Meera and I are studying in the library when suddenly the floor begins to violently heave and shake!`,
        soundCue: `rumble`,
        shake: `heavy`,
      },
      {
        id: `eq_2`,
        speaker: `Sound`,
        text: `*CRASH!* Books and heavy lamps are toppling from the high shelves!`,
        actionSfx: `CRASH!`,
        soundCue: `rumble`,
        shake: `heavy`,
      },
      {
        ...
        type: `choice`,
        speaker: `Meera`,
        question: `Books and plaster are falling! What is the safest protective action?`,
        options: [
          {
            id: `eq_opt_1`,
            text: `Drop to hands and knees, crawl under the heavy study desk, and hold tightly to its legs.`,
            isCorrect: !0,
          },
          {
            id: `eq_opt_2`,
            text: `Run to stand under the doorway frame.`,
            isCorrect: !1,
            feedbackNarrative: [
              {
                speaker: `Narrator`,
                text: `The 'doorway myth' is outdated. In modern buildings, doorways are not stronger than other parts of the house and the swinging door can crush your fingers.`,
                soundCue: `wrong`,
              },
            ],
            safetyTip: {
              title: `Doorway Myth Busted`,
              text: `Modern earthquake safety: DROP under a sturdy table, COVER your head, and HOLD ON! Do not stand in doorways.`,
            },
          },
          {
            id: `eq_opt_3`,
            text: `Sprint down the hallway towards the outdoor parking lot while shaking is active.`,
            isCorrect: !1,
            feedbackNarrative: [
              {
                speaker: `Narrator`,
                text: `Attempting to run while the ground is shaking violently leads to falls, broken bones, and severe trauma from falling overhead objects.`,
                soundCue: `wrong`,
              },
            ],
            safetyTip: {
              title: `Movement Rule`,
              text: `Do not attempt to run during active shaking. Drop, Cover, and Hold On where you are.`,
            },
          },
        ],
      },
        ...
        options: [
          ...
          },
          {
            ...
            feedbackNarrative: [
              {
                speaker: `Narrator`,
                text: `Wasting time gathering belongings puts you at risk of falling debris from aftershocks.`,
                soundCue: `wrong`,
              },
            ],
            safetyTip: {
  ...
  {
    id: `fire`,
    title: `Fire Drill Adventure`,
    subtitle: `A story about rapid escape, smoke avoidance, and fire safety.`,
    thumbnail: `/games/disaster-adventure/assets/thumb_fire-BqWnNS3S.png`,
    background: `/games/disaster-adventure/assets/bg_fire_room-MS4Z9Ks1.png`,
    category: `Fire & Evacuation`,
    badge: `Fire Safety Marshall`,
    badgeIcon: `🔥`,
    difficulty: `Beginner`,
    duration: `5 mins`,
    description: `Learn how to react when the smoke alarm sounds, test hot doors with the back of your hand, crawl low under smoke, and follow escape plans.`,
    scenes: [
      {
        id: `fire_1`,
        speaker: `Sound`,
        text: `*BEEP! BEEP! BEEP!* The smoke alarm on the hallway ceiling is shrieking at maximum volume!`,
        actionSfx: `ALARM!`,
        soundCue: `alarm`,
        shake: `mild`,
      },
      {
        id: `fire_2`,
        speaker: `Ishaan`,
        text: `Meera! There's a thick layer of dark smoke gathering along the upper ceiling of the hallway!`,
        shake: !1,
      },
      {
        id: `fire_3_choice`,
        type: `choice`,
        speaker: `Meera`,
        question: `Smoke rises and fills the upper half of the room with toxic carbon monoxide. How should we navigate through?`,
        options: [
          {
            id: `fire_opt_1`,
            text: `Drop to your hands and knees and crawl low beneath the smoke layer.`,
            isCorrect: !0,
          },
          {
            id: `fire_opt_2`,
            text: `Stand tall and sprint as fast as possible with deep breaths.`,
            isCorrect: !1,
            feedbackNarrative: [
              {
                speaker: `Narrator`,
                text: `Standing tall forces you to inhale superheated toxic smoke and poisonous gases. Just two breaths of thick smoke can cause you to pass out.`,
                soundCue: `wrong`,
              },
            ],
            safetyTip: {
              title: `Crawl Low Rule`,
              text: `Crawl low on your hands and knees! The cleanest, coolest, and most breathable air is closest to the floor (12 to 24 inches above ground).`,
            },
          },
        ],
      },
        ...
        options: [
          ...
          },
          {
            ...
            feedbackNarrative: [
              {
                speaker: `Narrator`,
                text: `If there is fire on the other side, the handle could be blazing hot and burn your hand severely.`,
                soundCue: `wrong`,
              },
            ],
            safetyTip: {
  ...
  },
  {
    ...
    subtitle: `A story about flash flood precautions and fast water safety.`,
    thumbnail: `/games/disaster-adventure/assets/thumb_flood-BhpcqZWm.png`,
    background: `/games/disaster-adventure/assets/bg_flood_school-BCgHLNb2.png`,
    category: `Water & Flooding`,
    badge: `Flood Navigator Pro`,
    badgeIcon: `🌊`,
    difficulty: `Intermediate`,
    duration: `5 mins`,
    description: `Learn the life-saving rule "Turn Around, Don't Drown", handle rising flood water inside buildings, and stay safe from hidden hazards.`,
    scenes: [
      {
        id: `flood_1`,
        speaker: `Sound`,
        text: `*SPLASH!* Torrential monsoon rains have caused the river to burst its banks! Brown water is surging down the streets.`,
        actionSfx: `SURGE!`,
        soundCue: `thunder`,
        shake: `mild`,
      },
      {
        id: `flood_2`,
        speaker: `Ishaan`,
        text: `The water level on the road outside is rising rapidly. We need to reach the community evacuation center.`,
        shake: !1,
      },
      {
        id: `flood_3_choice`,
        type: `choice`,
        speaker: `Meera`,
        question: `There is 10 inches of fast-moving murky brown water flowing across the road bridge. What should we do?`,
        options: [
          {
            id: `flood_opt_1`,
            text: `Do not cross! Turn around and seek high ground or an elevated concrete building floor.`,
            isCorrect: !0,
          },
          {
            id: `flood_opt_2`,
            text: `Wade through the water quickly while holding hands.`,
            isCorrect: !1,
            feedbackNarrative: [
              {
                speaker: `Narrator`,
                text: `Just 6 inches of fast-moving water can sweep a full-grown adult off their feet! Murky flood water hides open manholes and sharp debris.`,
                soundCue: `wrong`,
              },
            ],
            safetyTip: {
              title: `Turn Around Don't Drown`,
              text: `Never walk, swim, or drive through moving flood water. Turn Around, Don't Drown!`,
            },
          },
        ],
      },
        ...
        options: [
          ...
          },
          {
            ...
            feedbackNarrative: [
              {
                speaker: `Narrator`,
                text: `Water is an excellent conductor of electricity. Entering flooded areas with active electronics can cause electrocution.`,
                soundCue: `wrong`,
              },
            ],
            safetyTip: {
  ...
  {
    id: `lockdown`,
    title: `Lockdown Safety Adventure`,
    subtitle: `A story about quiet discipline and facility emergency lockdowns.`,
    thumbnail: `/games/disaster-adventure/assets/thumb_lockdown-CA8OUiZh.png`,
    background: `/games/disaster-adventure/assets/bg_lockdown_room-UhFnKfim.png`,
    category: `Facility & Public Safety`,
    badge: `Lockdown Protocol Master`,
    badgeIcon: `🔒`,
    difficulty: `Beginner`,
    duration: `4 mins`,
    description: `Learn the universal safety protocol: Locks, Lights, Out of Sight. Master smartphone silence discipline and staying calm.`,
    scenes: [
      {
        id: `lock_1`,
        speaker: `Sound`,
        text: `*ANNOUNCEMENT CHIME* Attention all staff and students: Initiate emergency lockdown protocol immediately. Locks, Lights, Out of Sight.`,
        actionSfx: `LOCKDOWN ALERT!`,
        soundCue: `siren`,
        shake: !1,
      },
      {
        ...
        type: `choice`,
        speaker: `Ishaan`,
        question: `The lockdown alarm has sounded. What are the immediate actions inside the room?`,
        options: [
          {
            id: `lock_opt_1`,
            text: `Lock the door, turn off all lights, draw window blinds, and move out of sight against a solid wall.`,
            isCorrect: !0,
          },
          {
            id: `lock_opt_2`,
            text: `Open the door to look outside and shout for information.`,
            isCorrect: !1,
            feedbackNarrative: [
              {
                speaker: `Narrator`,
                text: `Opening doors or peering outside exposes you and everyone in the room to immediate danger. Doors must be secured at once.`,
                soundCue: `wrong`,
              },
            ],
            safetyTip: {
              title: `Lockdown Rule`,
              text: `Immediately lock the door. Never open it until verified emergency personnel with keys open it.`,
            },
          },
        ],
      },
        ...
        options: [
          ...
          },
          {
            ...
            feedbackNarrative: [
              {
                speaker: `Narrator`,
                text: `During a security lockdown, an intruder might pull the fire alarm to force people out into the hallways.`,
                soundCue: `wrong`,
              },
            ],
            safetyTip: {
...
function le() {
  let [e] = (0, _.useState)(ce),
    [t, n] = (0, _.useState)(null),
    [r, i] = (0, _.useState)([]);
  return (0, T.jsx)(`div`, {
    className: `min-h-screen bg-[#FAF7F2] text-[#1C221E] font-comic selection:bg-[#587B64] selection:text-white`,
    children: t
      ? (0, T.jsx)(se, {
          adventure: t,
          onClose: () => n(null),
          onComplete: (e) => {
            r.includes(e) || i((t) => [...t, e]);
          },
        })
      : (0, T.jsx)(oe, {
          adventures: e,
          ...
          completedAdventures: r,
        }),
  });
}
(0, v.createRoot)(document.getElementById(`root`)).render(
  (0, T.jsx)(_.StrictMode, { children: (0, T.jsx)(le, {}) }),
);
